...
?>
                   ...
                   <br>
  <span class="profile-rating"><i><?php
    echo $rows['bio'];
?></i></span><br>
...
?>" name="first_name" id="first" required>

          <label for="last name"><b>Last Name</b></label>
          <input type="text" value="<?php
    echo $rows['last_name'];
?>" name="last_name" id="last" required>

      <label for="bio"><b>Bio</b></label>
          <input type="text" placeholder="Enter Bio" value="<?php
    echo $rows['bio'];
?>" name="bio" id="bio" >
...
?>" name= "phone" id="phone" required>
          ...
          <input type="text" placeholder="Enter Country name" value="<?php
    echo $rows['country'];
?>" name="country" id="country">

          <label for="state"><b>State Name</b></label>
          <input type="text" placeholder="Enter State name" value="<?php
    echo $rows['state'];
?>" name="state" id="state">

          <label for="University name"><b>University Name</b></label>
          <input type="text" placeholder="Enter University name" value="<?php
    echo $rows['university'];
?>" name="university" id="university">

          <label for="course"><b>Course Name</b></label>
          <input type="text" placeholder="Enter Course name" value="<?php
    echo $rows['course'];
?>" name="course" id="course">
    ...
    if ($rows['course_year'] == "1st") {
        echo "selected";
    }
?> >1st</option>
      <option value="2nd" <?php
    if ($rows['course_year'] == "2nd") {
        echo "selected";
    }
?> >2nd</option>
      <option value="3rd" <?php
    if ($rows['course_year'] == "3rd") {
        echo "selected";
    }
?> >3rd</option>
      <option value="4th" <?php
    if ($rows['course_year'] == "4th") {
        echo "selected";
    }
?> >4th</option>
        </select><br>
          ...
          <input type="text" placeholder="Enter Facebook URL" value="<?php
    echo $rows['facebook_url'];
?>" name="facebook_url" id="facebook url" >

          <label for="github url"><b>Github URL</b></label>
          <input type="text" placeholder="Enter Github url" value="<?php
    echo $rows['github_url'];
?>" name="github_url" id="github url" >

          <label for="linkedin url"><b>Linkedin URL</b></label>
          <input type="text" placeholder="Enter linkedin url" value="<?php
    echo $rows['linkedin_url'];
?>" name="linkedin_url" id="linkedin url">
        <br><br>
...
<?php
    if (isset($_POST['submit'])) {
        ...
        if ($imgFile) {
            ...
            $userpic = $rows['image']; // old image from database
        }
